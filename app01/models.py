...
class Category(models.Model):
    ...
    blog = models.ForeignKey(to="Blog", to_field="nid", on_delete=True)  # 外键关联博客，一个博客站点可以有多个分类
...
class Tag(models.Model):
    ...
    blog = models.ForeignKey(to="Blog", to_field="nid", on_delete=True)  # 所属博客
...
class ArticleDetail(models.Model):
    ...
    article = models.OneToOneField(to="Article", to_field="nid", on_delete=True)
...
class ArticleUpDown(models.Model):
    ...
    """
    nid = models.AutoField(primary_key=True)
    user = models.ForeignKey(to="UserInfo", null=True, on_delete=True)
    article = models.ForeignKey(to="Article", null=True, on_delete=True)
